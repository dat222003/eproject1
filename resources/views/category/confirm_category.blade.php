...
{{--            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalcofirm">--}}
{{--                Delete--}}
{{--            </button>--}}
...
{{--    <!-- Modal -->--}}
{{--    <div class="show-modal modal fade " id="modalcofirm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">--}}
